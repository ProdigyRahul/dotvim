return {
  ...
  config = function()
    require("claude-code").setup({
      ...
      window = {
        split_ratio = 0.5,      -- 50% of screen for the terminal window
        ...
        -- Floating window configuration (if you want to use float mode)
        float = {
          width = "85%",        -- 85% of editor width
      ...
      keymaps = {
        toggle = {
          ...
          terminal = "<C-\\>",        -- Terminal mode keymap for toggling Claude Code (Ctrl+\)
          variants = {
